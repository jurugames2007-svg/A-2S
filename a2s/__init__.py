...
__version__ = "1.28.0"
__all__ = ["__version__", "APISpec", "ProcessManager", "PublicAPIManager",
           "BookToSkill", "SEOAuditor", "WebCrawler", "MediaExtractor",
           "Task", "TaskOrchestrator", "AegisProject", "ProjectConfig",
           "AegisJupyter", "AutonomousLoop", "ChangeProposal", "ChangeLimits"]
...
from .integrations import APISpec, ProcessManager, PublicAPIManager
from .web_integrations import BookToSkill, SEOAuditor, WebCrawler
from .media_orchestration import MediaExtractor, Task, TaskOrchestrator
from .project import AegisProject, ProjectConfig
from .jupyter import AegisJupyter
from .autonomy import AutonomousLoop, ChangeLimits, ChangeProposal
